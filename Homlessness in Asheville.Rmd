...
# Homeless Status Offenses{data-navmenu="Indicators"}
...
### Total Homeless Status Offenses by Year

```{r}
library(gganimate)
apdpi<-read_csv("apdpi.csv")
apdpi$year<-as.factor(apdpi$year_occurred)

p<-ggplot(apdpi, aes(x=lat, y=lon, color=year)) + geom_point() +
...
# Housing Data{data-navmenu="Indicators"}
